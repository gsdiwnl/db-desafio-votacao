/**
 * Filename:    MissingServletRequestParameterHandler.java
 *
 * Description: Implementation of the MissingServletRequestParameterHandler class.
 *
 * Revision:    1.0
 *
 * Changed by:  gd
        ...
        Handler<MissingServletRequestParameterException>
{
    ...
    public ResponseEntity<Error> handle( MissingServletRequestParameterException ex ) 
    {
